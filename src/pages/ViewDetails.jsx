  ...
  return (
    <>
      <p className="text-center mt-5 text-4xl font-bold">
        View <span className="text-yellow-500">Details</span>
      </p>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: "easeInOut" }}
        className={`max-w-[1400px] mx-auto rounded-2xl shadow-lg overflow-hidden mt-5 border transition-colors duration-300 
      ...
      >
        ...
        <div className="w-full md:w-1/2 lg:w-[60%]">
          <motion.img
            ...
            className="w-full h-[680px] object-contain md:object-cover"
          />
        </div>
